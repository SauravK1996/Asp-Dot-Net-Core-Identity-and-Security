    ...
    public class IdentityController  :Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if((await _userManager.FindByEmailAsync(model.Email)) == null)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        await emailSender.SendEmailAsync("skbk1996@gmail.com", user.Email, "Confirm your email address", confirmationLink);
        ...
        public async Task<IActionResult> Signin(SigninViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //    //{
                //    //    ModelState.AddModelError("Claim","User not in IT department.");
                //    //    return View(model);
                //    //}
